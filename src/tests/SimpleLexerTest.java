 ...
 */
	...
	private class Tester {
		...
		public Tester(String input) {
			TokenReader idReader = new IdentifierReader();
			TokenReader intReader = new IntReader();
			TokenReader wsReader = new WhitespaceReader();
			TokenReader wordReader = new WordReader("word", false);
			ArrayList<TokenReader> tokenReadersList = new ArrayList<TokenReader>();
			tokenReadersList.add(idReader);
			tokenReadersList.add(intReader);
			tokenReadersList.add(wsReader);
			tokenReadersList.add(wordReader);		
			lexer = new SimpleLexer(input, tokenReadersList);
		}
